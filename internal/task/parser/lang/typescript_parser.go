...
func NewTypeScriptTSParser() (CodeParser, error) {
...
func (p *typeScriptParser) Split(codeFile *types.CodeFile, maxTokensPerChunk, overlapTokens int) ([]*types.CodeChunk, error) {
...
func (p *typeScriptParser) Parse(codeFile *types.CodeFile) (*sitter.Node, error) {
