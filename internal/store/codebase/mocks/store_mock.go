...
func (m *MockStore) Init(ctx context.Context, clientId, codebasePath string) (*types.Codebase, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Init", ctx, clientId, codebasePath)
...
func (mr *MockStoreMockRecorder) Init(ctx, clientId, codebasePath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Init", reflect.TypeOf((*MockStore)(nil).Init), ctx, clientId, codebasePath)
}
