...
// protoc --go_out=. internal/store/codegraph/structure.proto

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.36.6
// 	protoc        v4.25.3
// source: internal/store/codegraph/structure.proto
...
func (x *Definition) Reset() {
	*x = Definition{}
	mi := &file_internal_store_codegraph_structure_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Definition) Descriptor() ([]byte, []int) {
	return file_internal_store_codegraph_structure_proto_rawDescGZIP(), []int{1}
}
...
var (
	...
	file_internal_store_codegraph_structure_proto_rawDescData []byte
)

func file_internal_store_codegraph_structure_proto_rawDescGZIP() []byte {
	file_internal_store_codegraph_structure_proto_rawDescOnce.Do(func() {
		file_internal_store_codegraph_structure_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_store_codegraph_structure_proto_rawDesc), len(file_internal_store_codegraph_structure_proto_rawDesc)))
	})
	return file_internal_store_codegraph_structure_proto_rawDescData
}
...
func init() { file_internal_store_codegraph_structure_proto_init() }
func file_internal_store_codegraph_structure_proto_init() {
	if File_internal_store_codegraph_structure_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_store_codegraph_structure_proto_rawDesc), len(file_internal_store_codegraph_structure_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_store_codegraph_structure_proto_goTypes,
		DependencyIndexes: file_internal_store_codegraph_structure_proto_depIdxs,
		MessageInfos:      file_internal_store_codegraph_structure_proto_msgTypes,
	}.Build()
	File_internal_store_codegraph_structure_proto = out.File
	file_internal_store_codegraph_structure_proto_goTypes = nil
	file_internal_store_codegraph_structure_proto_depIdxs = nil
}
