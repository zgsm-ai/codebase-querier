...
(import_declaration (import_spec_list (import_spec) @import.name) * (import_spec) * @import.name) @import
...
(source_file (const_declaration (const_spec name: (identifier) @const.name)) @const)
